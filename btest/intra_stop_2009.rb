analytics do
  ...
  open_position :intra_stop_2009, :time_period => 14 do |params, pass|
    ...
    indexes
    puts "#{symbol} #{indexes.join(',')}" unless indexes.empty?
    indexes
  end

  desc "Find all places where RSI gooes heads upwards of 70 OR go back under 30 after crossing 30"
  close_position :intra_stop_2009, :time_period => 14 do |params, pass|
...
backtests(:price => :close) do
  apply(:intra_stop_2009, :intraday_2009) do
#    make_test()
  end
end
