...
populations do
  ...
  # only use symbols with a history of 2000 days (8 years)
  liquid = 'min(volume) > 100000 and count(*) > 2000'
  year = 8
  ...
  scan "years_2000_2008", :start_date => "01/01/2000", :end_date => "01/31/2009", :conditions => liquid
end

backtests(:price => :close) do
  #apply(:rsi_oversold, :liquid_2008) do |position|
  apply(:rsi_oversold, :years_2000_2008) do |position|
