        ...
        base.made_resourceful do
          ...
          response_for(:create) do |format|
            format.html do
              ...
              set_default_redirect parent? ? nested_object_path : object_path
            end
            format.js
          end
          ...
          response_for(:create_fails) do |format|
            format.html do
              set_default_flash :error, "Errors prevented creation"
          ...
          response_for(:update_fails) do |format|
            format.html do
              set_default_flash :error, "Errors prevented the update"
          ...
          response_for(:destroy_fails) do |format|
            format.html do
              set_default_flash :error, "Errors prevented deletion"
