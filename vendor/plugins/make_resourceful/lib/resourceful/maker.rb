...
module Resourceful
  ...
  module Maker
    ...
    def add_helpers
      helper_method(:object_path, :objects_path, :new_object_path, :edit_object_path, :nested_object_path,
                    :object_url, :objects_url, :new_object_url, :edit_object_url, :nested_object_url,
